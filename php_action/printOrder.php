...
<table align="center" cellpadding="0" cellspacing="0" style="width: 100%;border:1px solid black;margin-bottom: 10px;">
               <tbody>
                  ...
                  <tr>
                     <td colspan="3" style="font-style: italic;font-weight: 600;text-decoration: underline;font-size: 25px;">Ramz Dlz Inventory System</td>
                  </tr>
                  <tr>
                     <td colspan="3" >PHILIPPINES,</td>
                  </tr>
                  <tr>
                     <td colspan="3" >Cagayan de Oro City, 9000</td>
                  </tr>
                  <tr>
                     <td colspan="3" >Tele: 1234567890,1478523690.</td>
                  </tr>
                  <tr>
                     <td colspan="3" >Email: sampleemail@yahoo.com</td>
                  </tr>
                  <tr>
                     <td colspan="3" style="text-decoration: underline;">sampleemail@yahoo.com</td>
                  </tr>
                  <tr>
            ...
            $x++;
                ...
                $table.= '
                  ...
                  <tr>
                     <td colspan="3" style="border-bottom: 1px solid black;border-left: 1px solid black;padding: 5px;">AC.NO. :- SampleAcc#123456</td>
                  ...
                  <tr>
                     <td colspan="3" style="border-left: 1px solid black;border-bottom: 1px solid black;padding: 5px;border-right: 1px solid black;">* Subject to payment             <span style="float: right;"> E.&amp;.O.E.</span></td>
                     <td rowspan="2" colspan="2" style="vertical-align: bottom;padding: 5px;color: red;border-right: 1px solid black;text-align: center;">for, Juan dela Cruz</td>
                  </tr>
                  <tr>
